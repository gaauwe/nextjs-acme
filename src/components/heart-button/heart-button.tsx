...
export default function HeartButton({ id, isLiked }: HeartButtonProps) {
  const htmlId = useId();
  const [pending, startTransition] = useTransition();

  const handleLike = (e: ChangeEvent<HTMLInputElement>) => {
    const action = e.currentTarget.checked ? addLikedSong : deleteLikedSong;
  ...
  return (
    <div className="heart-button flex text-white cursor-pointer items-center justify-center bg-primary rounded-full h-10 w-10 absolute right-2 bottom-2 opacity-0 group-hover:opacity-100 hover:brightness-95 transition-all duration-100 shadow-xl">
      <input
      ...
      <label htmlFor={htmlId} className="cursor-pointer">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 189.2 87.507" className="h-6 -ml-[5px] -mt-[3px] overflow-visible ">
